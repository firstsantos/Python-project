...
class Morcego(Mamifero, Ave):
    def emitir_som(self):
        return "Morcegos emitem sons ultrassônicos" # super. chama a implementação da class mãe, caso esse metódo tinha alguma ação
...
# Acessando métodos das classes `Mamíferos` e `Ave`
